...
declare namespace jabra {
     ...
     */
    type ButtonEventName = "mute" | "unmute" | "acceptcall" | "endcall" | "reject" | "flash" | "online" | "offline" | "linebusy" | "lineidle" | "redial" | "key0" | "key1" | "key2" | "key3" | "key4" | "key5" | "key6" | "key7" | "key8" | "key9" | "keyStar" | "keyPound" | "keyClear" | "Online" | "speedDial" | "voiceMail" | "LineBusy" | "outOfRange" | "intoRange" | "pseudoAcceptcall" | "pseudoEndcall" | "button1" | "button2" | "button3" | "volumeUp" | "volumeDown" | "fireAlarm" | "jackConnection" | "jackDisConnection" | "qdConnection" | "qdDisconnection" | "headsetConnection" | "headsetDisConnection";
    /**
     * Names of events describing device being added/removed.
     */
    type AttachedDeattachedEventName = "device attached" | "device detached";
    /**
     * Names of events presently without a type definition (subject to change).
     */
    type UntypedEventName = "busylight" | "hearThrough" | "batteryStatus" | "gnpButton" | "mmi" | "error";
    /**
     * All possible device events as discriminative  union.
     */
    type EventName = ButtonEventName | AttachedDeattachedEventName | "devlog" | UntypedEventName;
    /**
     ...
     */
    interface DeviceAttachedDeAttachedEvent {
    ...
    */
     ...
     */
    type EventCallback = (event: Event | DeviceAttachedDeAttachedEvent | ButtonEvent | DevLogEvent) => void;
    /**
    ...
    */
     ...
     */
    function addEventListener(nameSpec: AttachedDeattachedEventName, callback: (event: DeviceInfo) => void): void;
    function addEventListener(nameSpec: 'devlog', callback: (event: DevLogEvent) => void): void;
    function addEventListener(nameSpec: ButtonEventName, callback: (event: ButtonEvent) => void): void;
    function addEventListener(nameSpec: UntypedEventName, callback: (event: Event) => void): void;
    function addEventListener(nameSpec: EventName | RegExp | Array<EventName | RegExp>, callback: EventCallback): void;
    /**
     ...
     */
    function removeEventListener(nameSpec: AttachedDeattachedEventName, callback: (event: DeviceInfo) => void): void;
    function removeEventListener(nameSpec: 'devlog', callback: (event: DevLogEvent) => void): void;
    function removeEventListener(nameSpec: ButtonEventName, callback: (event: ButtonEvent) => void): void;
    function removeEventListener(nameSpec: UntypedEventName, callback: (event: Event) => void): void;
    function removeEventListener(nameSpec: EventName | RegExp | Array<EventName | RegExp>, callback: EventCallback): void;
    /**
    ...
    */
     ...
     */
    class Analytics {
        private deviceAnalyticsPerDeviceId;
        constructor();
    }
}
